	...
	while ($res=$stmt->fetch()){
		...
		<div class="col-sm-2 paddingTop20">
			...
			<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="profil" aria-hidden="true" >
				<div class="modal-dialog" >
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<hr>
							<center>
									<p class="text-left"><strong>formation: </strong> <?php  echo $_SESSION['formation'] ?>
									<p class="text-left"><strong>né le : </strong> <?php  date('d-m-Y', strtotime($_POST['birth'])) ?>
								</center>
							</div>
                ...
                <div id="ta_div" onload="javascript:ajax()"></div>
			</div>
