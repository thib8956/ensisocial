...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 13 Juin 2017 à 16:47
...
--
-- Structure de la table `chatgeneral`
--
...
(6, 'enseignant', 'L’équipe pédagogique de l’ENSISA associe en permanence l’enseignement supérieur, la recherche et le transfert de technologie. Orientée vers les secteurs d’activité en lien avec la recherche appliquée, l’innovation et le transfert de technologie, la formation s’adosse aux laboratoires de recherche de l’école. La recherche à l’ENSISA s’inscrit dans les stratégies régionale et nationale d’innovation en partenariat. Elle est, de plus, membre de réseaux d’écoles (Alsace Tech) et de réseaux thématiques.', 'default-group.png'),
...
--
-- Index pour la table `chatgeneral`
--
...
--
ALTER TABLE `authorcomment`
  MODIFY `pk_authorcomment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT pour la table `authornews`
--
ALTER TABLE `authornews`
  MODIFY `pk_authornews` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT pour la table `chatgeneral`
--
ALTER TABLE `chatgeneral`
...
--
ALTER TABLE `newscomment`
  MODIFY `pk_newscomment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
